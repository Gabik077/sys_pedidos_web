...
import { getEnvios, guardarEstadoPedido } from "@/app/services/pedidosService"; // Asegúrate de que estos endpoints existan
import { ComboDetalle, EnvioHeader } from "../../../types";
