...
import { handleImprimirVentaDelivery } from "@/app/facturacion/components/impresion/handleImprimirVentaDelivery";

export default function InformeVentasDeliveryView() {
